...
<div class="container-fluid">
  <a class="navbar-brand" href="index.php">
    ...
    <h2><center><font style="color: #032036;">BMW World</font></center><br></h2>
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="card-img-overlay">
            ...
            <p class="card-text"><a class="btn btn-outline-light" href="book.php" role="button">Book Now</a></p>
          </div>
        </div>
      </div> 
      </div><br><br>
      <div class="row">
        <div class="col"><div class="card bg-light text-white">
        ...
        <div class="col"><div class="card bg-light text-white">
          ...
          <div class="card-img-overlay">
            <h5 class="card-title">Sheer Driving Experience</h5>
            <p class="card-text">Join The BMW Legacy</p>
            <p class="card-text"><a class="btn btn-outline-light" href="book.php" role="button">Book Now</a></p>          </div>
        </div></div>
      </div><br><br>
      <div class="row">
        <div class="col"><div class="card bg-light text-white">
